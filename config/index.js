export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx630c8b85b3239969",

   // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ab4f51feb6f90eac14f262aff6c5116f",
  ...
  USERS: [
    {
      ...
      name: "佳佳",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "owYNU6PGmE0TQU7pQtM2WJLmOMUE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "Ey6qVCMZYHLdU-zRLJPgcAcVlU093-vTl_BCSYpIOXw",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "项城",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "亲爱的老婆", "year": "2004", "date": "10-03"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "09-11"},
